...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'c61d143f-b214-434d-82db-40e1f654cae3' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8f176bff-4eab-4971-8127-6066fb6f3f75');
      cy.get(`[data-cy="name"]`).should('have.value', '8f176bff-4eab-4971-8127-6066fb6f3f75');
